 ...
 * Added conditional logic to `resource "aws_s3_bucket_public_access_block" "kinesis_firehose_s3_bucket" {}` per [#PR6](https://github.com/disney/terraform-aws-kinesis-firehose-splunk/pull/60).
